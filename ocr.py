...
print("Выведет программу в виде строк ADDR: (+)? DATA, это можно засунуть в ./disas.py -ab -f=v\n")
print("Точно подходит для 2 и 3 лабы\n")
print("Tesseract на удивление очень плохо воспринимает картинку даже в обработанном виде,")
print("поэтому нужно вручную задать интерпретацию глифов\n")
print("Программа по ходу считывания будет спрашивать какому символу соотвествует неизвестный ей глиф\n")
print("По задумке вопросов должно быть <= 17, но в вариантах глифы немного отличаются,")
print("из-за чего в разных местах один и тот же символ может быть воспринят как разные глифы\n")
